...
print("*** Forecasts of nr. of Air Passengers using FASTSRegressor...")
...
X, y = us.embed_to_X_y(passengers, n_lags=fh, name='passengers')
...
best_fasts.compare_to_baselines(
    y_train, y_test, season=12, fh=fh, bar_plot=True, metric="mape")
...
full_series_index = pd.date_range(
    start=passengers.index[0], periods=(len(passengers) + fh))
